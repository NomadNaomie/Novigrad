...
public class PhotoID extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_photo_i_d);
        String role  = getIntent().getStringExtra("Role");

        btn2 = findViewById(R.id.PIDSubmit);
        FN = findViewById(R.id.PIDFN);
        LN = findViewById(R.id.PIDLN);
        DB = findViewById(R.id.PIDDB);
        IMG = findViewById(R.id.PIDS);
        ADDR = findViewById(R.id.PIDADR);
        POS = findViewById(R.id.PIDPR);
            ...
            btn2.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (!nameValidation(FN.getText().toString()) || !nameValidation(LN.getText().toString()) || FN.getText().length()<=0 || LN.getText().length()<=0){
                        ...
                        Toast.makeText(PhotoID.this, "Request Submitted", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
